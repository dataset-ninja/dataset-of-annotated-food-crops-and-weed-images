...
def convert_and_upload_supervisely_project(
    ...
    images_path = os.path.join("Ronin_OPEN_DB","raw images")
    bboxes_path = os.path.join("Ronin_OPEN_DB","annotations")
    batch_size = 30
    ds_name = "ds"
    ann_ext = ".xml"
    ...
    crop = sly.ObjClass("crop", sly.Rectangle)
    project = api.project.create(workspace_id, project_name, change_name_if_conflict=True)
    meta = sly.ProjectMeta(obj_classes=[weed, crop])
